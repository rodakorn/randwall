...
const PictureChooser = class PictureChooser extends ModalDialog.ModalDialog {
  ...
  _create_searched_thumbs_table(images) {
  ...
  start_close() {
    Tweener.addTween(this._dialogLayout, {
      opacity: 0, time: 0.5, transition: 'easeOutQuad', onCompleteParams: [this], onComplete: function (object) {
        object.close();
      }
    });
  }
